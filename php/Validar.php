...
class Validar {
	...
	private const RESTRICCIONES = [	'seccion'=>['obligatorio'=>true,
						         	...
						         	'inputDetalleDelGasto'=>['obligatorio'=>true,
						           	 						       'longitudMinima'=>2,
						           	 						       'longitudMaxima'=>150,
	...
	private const PROPIEDADES = ['destruirSesion'=>['idSesion', 
							 	        ...
							 	        'guardarIngreso'=>['seccion',
							 							             			 'inputImporte',
							 							                   'inputOrigenDeIngreso',
							 							                   'dia',
							 							                   'mes',
							 							                   'año'],
							 	        'guardarGasto'=>['seccion',
                                             'inputSaldo',
                        ...
                        'guardarSaldo'=>['seccion', 
                                         ...
                                         'año'],
							 					'buscarIngresoPorMesAño'=>['seccion', 
							 																		 'año', 
							 																		 'mes'],
							 					'buscarIngresoPorMesAñoOrigenDeIngreso'=>['seccion',
							 																										'inputOrigenDeIngreso',
							 																										'año',
							 																										'mes'],
							 					'buscarGastosPorAñoMesSaldo'=>['seccion', 
							 																				 'inputSaldo',
							 																				 'mes',
                                                  		 'año'],
                        'buscarGastosPorAñoMesSaldoCategoriaDeGasto'=>['seccion',
                        																							 'inputSaldo', 
                        																							 'inputCategoriaDeGasto',
                        																							 'mes',
                                                  						 				 'año'],
                        'buscarGastoPorId'=>['seccion',
                      											 'idGasto'],
                        'buscarSaldoPorId'=>['seccion',
                      											 'inputSaldo'],

                      	'buscarSaldoPorFkSaldoIngreso'=>['seccion',
                      																	 'idIngreso' ],
                      	'buscarGastoTotalPorAñoMesInputSaldoInputCategoriaDeGasto'=>['seccion', 
    		                                                                             'inputSaldo', 
    		                                                                             'inputCategoriaDeGasto', 
    		                                                                             'mes', 
    		                                                                             'año'],

							 					'modificarSaldoPorOrigen'=>['seccion', 
							 																		  'inputImporte',
							 																		  'dia',
                                                  	'mes',
                                                  	'año',
                        ...
                        'modificarSaldoPorId'=>['seccion',
                        												'inputImporte',
                      													'idSaldo'],

                        'eliminarGastoPorId'=>['seccion',
                      											   'idGasto'],

                      	'eliminarSaldoPorId'=>['seccion',
                      												 'idSaldo'],

                      	'eliminarIngresoPorId'=>['seccion',
                      													 'idIngreso']
	];
